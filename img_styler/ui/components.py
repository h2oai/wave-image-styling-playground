                ...
                if q.client.prompt_model == "prompt_sd"
                    ...
                    ui.choice_group(
                        ...
                        choices=[
                            ...
                            ui.choice(name=ControlNetMode.HOUGH, label="Hough2Image"),
                            ui.choice(name=ControlNetMode.NORMAL, label="Normal2Image"),
                            ui.choice(name=ControlNetMode.POSE, label="Pose2Image"),
                            ui.choice(name=ControlNetMode.SEG, label="Seg2Image"),
                            ui.choice(name=ControlNetMode.FAKE_SCRIBBLE, label="Fake-Scribble2Image"),
                        ],
                        trigger=True,
                        tooltip="Stable Diffusion is a text-to-image latent diffusion model, created by the researchers and engineers from CompVis, Stability AI and LAION.",
                    ),
